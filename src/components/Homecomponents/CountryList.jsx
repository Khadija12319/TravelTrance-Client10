...
const CountryList = () => {
    return (
        <div className="mt-14 footer-background">
...
<div className="flex gap-7 p-8">
    ...
    <div>
        <p className="text-white">01. Asia</p>
...
<div className="flex gap-7 p-8">
    ...
    <div>
        <p className="text-white">02. Europe</p>
...
<div className="flex gap-7 p-8">
    ...
    <div>
        <p className="text-white">03. America</p>
...
<div className="flex gap-7 p-8">
    ...
    <div>
        <p className="text-white">04. Africa</p>
...
<div className="flex gap-7 p-8">
    ...
    <div>
        <p className="text-white">05. Middle East</p>
...
<div className="flex gap-7 p-8">
    ...
    <div>
        <p className="text-white">06. Central Asia</p>
