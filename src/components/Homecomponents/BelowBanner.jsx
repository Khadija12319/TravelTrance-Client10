const BelowBanner = () => {
    return (
        <div className="container mx-auto mt-16 mb-16 overflow-hidden">
            <h3 className="text-center text-3xl font-playfair font-extrabold text-orange-600">Unforgettable Journeys in Asia</h3>
            <h3 className="text-center py-5 font-montserrat text-black text-6xl font-bold dark:text-gray-600">Experience of Our Travelers</h3>
            <p className="text-center py-3 font-montserrat font-light text-black text-base leading-9 dark:text-gray-600">Step into the captivating tales spun by our adventurers. Each journey is a tapestry of discovery, woven<br /> with moments that linger long after the return. Explore the untold narratives of wanderlust, where every destination becomes a chapter in a travelers memoir. Embrace<br/> the allure of the unknown, for in these expeditions, true treasures lie in the experiences shared.</p>
            <div>
            <div className="container mx-auto md:px-5 py-2 lg:px-32 lg:pt-10 flex items-center">
      <div className="-m-1 flex flex-row sm:flex-wrap md:-m-2">
        <div className="flex w-full sm:w-1/2 flex-wrap lg:flex-row flex-row-reverse">
          <div className="w-full lg:w-1/2 p-1 md:p-2">
            ...
            />
            <p className="text-white font-montserrat md:text-2xl font-bold text-center -translate-y-14">Bangladesh</p>
          </div>
          <div className="w-full lg:w-1/2 p-1 md:p-2">
            <img
              alt="gallery"
            ...
            />
            <p className="text-white font-montserrat md:text-2xl font-bold text-center -translate-y-14">Thailand</p>
          </div>
          <div className="w-full p-1 md:p-2">
            ...
            />
            <p className="text-white font-montserrat md:text-2xl font-bold text-center -translate-y-14">Indonesia</p>
          </div>
        </div>
        <div className="flex w-full sm:w-1/2 flex-wrap">
          <div className="w-full p-1 md:p-2">
            ...
            />
            <p className="text-white font-montserrat md:text-2xl font-bold text-center -translate-y-14">Malaysia</p>
          </div>
          <div className="w-1/2 p-1 md:p-2">
            ...
            />
            <p className="text-white font-montserrat md:text-2xl font-bold text-center -translate-y-14">Vietnam</p>
          </div>
          <div className="w-1/2 p-1 md:p-2">
            <img
              alt="gallery"
            ...
            />
            <p className="text-white font-montserrat md:text-2xl font-bold text-center -translate-y-14">Cambodia</p>
          </div>
        </div>
      </div>
    </div>
