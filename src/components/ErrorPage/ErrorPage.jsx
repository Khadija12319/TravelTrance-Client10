    ...
    return (
        <div>
            ...
            <div className="w-full lg:w-1/2">
                ...
                <Link to="/">
                <button className="w-full lg:w-auto my-4 rounded-md px-1 sm:px-16 py-5 bg-orange-600 text-white hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50">Go back to Homepage</button>
                </Link>
            </div>
        </div>
        </div>
